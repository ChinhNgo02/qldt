                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="teacher" class="choices form-select" id="teacher" name="teacher">
                                            ...
                                            <option value="{{ $data->user_id }}" @if (!empty($current_teacher))
                                                @if($current_teacher->
                                                id == ($data->user_id)) selected
                                                @endif @endif >{{ $data->user_name
                                                }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    <button type="submit" onclick="return validate()" class="btn btn-primary me-1 mb-1">
                                        Submit
                                    </button>
