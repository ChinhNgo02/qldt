    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header">
            <div class="d-flex justify-content-between">
                <div class="logo">
                    <a href="{{route('dashboard')}}"><img src="{{asset('images/logo/logo.png')}}" alt="Logo"
                            srcset=""></a>
                </div>
                <div class="toggler">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @endif
                @if ( auth()->user()->level >= 1 || auth()->user()->level <= 4) <li
                    class="sidebar-item {{'classes' == request()->path() ? 'active' : ''}}">
