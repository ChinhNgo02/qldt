...
<link href="{{ asset('css/pages/calendar.css') }}" rel="stylesheet"
    type="text/css" />
{{-- css end --}}
@endpush
@php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <button data-bs-toggle="modal"
                                    data-bs-target="#all-student-modal"
                                    style="text-align: left" class="btn
                                    btn-white
                                    p-0">
                                    <h6 class="text-muted font-semibold">Tổng số
                                        học sinh</h6>
                ...
                <div class="card">
                    <div class="card-body px-3 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <button data-bs-toggle="modal"
                                    data-bs-target="#present-student-modal"
                                    style="text-align: left" class="btn
                                    btn-white
                                    p-0">
                                    <h6 class="text-muted font-semibold">Số học
                                        sinh đi học đầy đủ</h6>
                                    <h6 class="font-extrabold mb-0">{{
                                        count($numberStudentPresentFullDay) }}</h6>
                                </button>
                ...
                <div class="card">
                    <div class="card-body px-3 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <button data-bs-toggle="modal"
                                    data-bs-target="#absent-student-modal"
                                    style="text-align: left" class="btn
                                    btn-white
                                    p-0">
                                    <h6 class="text-muted font-semibold">Số học
                                        sinh nghỉ quá 3 buổi</h6>
                                    <h6 class="font-extrabold mb-0">{{
                                        count($numberStudentAbsentMoreThan3Sessions)
                                        }}
                                    </h6>
                                </button>
            ...
            <div class="card-body">
                <div class="badges mb-2">
                    <center>
                        ...
                        <span class="badge bg-danger">Đã học nhưng chưa điểm
                            danh</span>
                    </center>
                </div>
                <div id='calendar'></div>
...
<div class="modal fade text-left w-100" id="present-student-modal" tabindex="-1"
    role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel16">Danh sách học sinh
                    đi học đầy đủ</h4>
...
<div class="modal fade text-left w-100" id="absent-student-modal" tabindex="-1"
    role="dialog"
    aria-labelledby="myModalLabel16" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable
        modal-xl" role="document">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-lg">
                        ...
                        <tbody>
                            @foreach ($numberStudentAbsentMoreThan3Sessions as
                            $student)
                            <tr>
                                <td>{{ $student['id'] }}</td>
                                <td>{{ $student['name'] }}</td>
...
<div class="modal fade text-left w-100" id="all-student-modal" tabindex="-1"
    role="dialog"
    aria-labelledby="myModalLabel16" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable
        modal-xl" role="document">
