                            ...
                            <tr>
                                ...
                                <td class="min">
                                    <label class="block text-gray-500
                                        font-semibold sm:border-r sm:pr-4">
                                        <input name="attendance[{{ $student->id
                                        }}]"
                                        class="leading-tight form-check-input "
                                        type="radio" value="1" checked>
                                    </label>
                                </td>
                                <td class="min">
                                    <label class="ml-4 block text-gray-500
                                        font-semibold">
                                        <input name="attendance[{{ $student->id
                                        }}]"
                                        class="leading-tight form-check-input "
                                        type="radio" value="2"
                                        {{ $student->attendance()->where('schedule_id',
                                        $schedules->id)->first()->status == 2 ?
                                        'checked' : '' }}>
                                    </label>
                                </td>
                                <td class="min">
