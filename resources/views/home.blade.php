        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-7 col-lg-7">
                                <h3 class="font-semibold">Chào {{ auth()->user()->name
                                    }} !</h3>
                                <h6 class="font-semibold text-muted mb-0 mt-2">Chào
                                    mừng đến với J2School</h6>
                            </div>

                            <div class="col-12 col-md-5 col-lg-5 d-flex
                                justify-content-center">
                                <img style="width: 300px" src="{{
                                    asset('images\samples\school-fluid.png') }}" alt="logo" class="img-fluid">
                            </div>
            ...
            <div class="col-12 col-lg-12">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 col-md-6">
                        <div class="card">
                            <button data-bs-toggle="modal" data-bs-target="#numberOfSessions" style="text-align: left"
                                class="btn btn-white
                                p-0">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-10 col-md-8">
                                            <h6 class="text-muted
                                                font-semibold">Số buổi đã học</h6>
                                            <h6 class="font-extrabold mb-0">{{
                                                count($sessions) }}</h6>
                                        </div>
                                    </div>
            ...
            <div class="row">
                            ...
                            <div class="card-body">
                                <div class="content w-100">
                                    <div class="calendar-container">
                                        <div class="calendar">
                                            <div class="year-header">
                                                <span class="left-button fa
                                                    fa-chevron-left" id="prev">
                                                </span>
                                                <span class="year" id="label"></span>
                                                <span class="right-button fa
                                                    fa-chevron-right" id="next">
                                                </span>
                                            </div>
                                    ...
                                    <div class="dialog" id="dialog">
                                        <h2 class="dialog-header"> Thêm lịch
                                        </h2>
                                        <form class="form" id="form">
                                            <div class="form-container" align="center">
                                                <label class="form-label" id="valueFromMyButton" for="name">Tên sự
                                                    kiện</label>
                ...
                <div class="col-12 col-lg-3">
                    <div class="card pb-4">
                        ...
                        <div class="card-body" style="max-height: 539px;
                            overflow-y: scroll;">
                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                <div class="col-12 col-md-12">
                                    <center>
                                        <div class="avatar img-thumbnail">
                                            <img src="{{
                                                asset('images/faces/3.jpg') }}" alt="" srcset="" style="width: 120px;
                                                height:120px;">
                                        </div>
                                    </center>
                                </div>
                                <div class="col-12 col-md-12 mt-3">
                                    <center>
                                        <h5 class="font-bold">{{ $teacher->name
                                            }}</h5>
                                        <h6 class="text-muted font-semibold">{{
                                            $teacher->email }}</h6>
                                        <h6 class="font-extrabold mb-0">{{
                                            $teacher->subject }}</h6>
                                        <a href="mailto:{{ $teacher->email }}" class="btn btn-primary mt-3">Liên
                                            hệ</a>
                                    </center>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel16">Danh sách các
                        lớp đang học</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="mt-2">Môn: {{ $class['subject_name']
                                    }}</p>
                                <p class="mt-0">Ca:
                                    @if ($class['shift'] == 1)
                                    Sáng
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-12 mt-3">
                                    <center>
                                        ...
                                        <h6 class="text-muted font-semibold">{{
                                            $admin->email }}</h6>
                                        <a href="mailto:{{ $admin->email }}" class="btn btn-primary mt-3">Liên
                                            hệ</a>
                                    </center>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-footer border-top-0 text-right pt-2
                            pb-2">
                ...
                <div class="col-12 col-lg-3 col-md-6">
                    <div class="card">
                        ...
                        <div class="card-footer border-top-0 text-right pt-2
                            pb-2">
                            <a href="{{ route('subject.index') }}"><button class="btn btn-light-primary">Xem chi
                                    tiết nè</button></a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="content w-100">
                                <div class="calendar-container">
                                    <div class="calendar">
                                        ...
                                        <button class="button" id="add-button">Thêm
                                            lịch</button>
                                    </div>
                                </div>
                                <div class="events-container">
