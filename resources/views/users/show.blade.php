                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <span class="text-danger">{{ $errors->first('birthday')
                                    }}</span>
                                @endif
                            </div>
                            <div class="col-12">
                            ...
                            <div class="list-unstyled mb-0">
                                <div class="form-check form-check-lg d-flex align-items-end">
                                    <input class="form-check-input me-2" type="checkbox" name="isChangePassword"
                                        id="changePassword" />
                                    <label class="form-check-label text-gray-600" for="isChangePassword">
                                        Thay đổi mật khẩu
                                    </label>
                                    @if ($errors->has('isChangePassword'))
                                    <span class="text-danger">{{ $errors->first('isChangePassword')
                                        }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="col-12 hide" id="editPassword">
                                <div class="form-group">
                                    ...
                                    <input type="password" id="currentPassword" class="form-control"
                                        name="currentPassword" disabled />
                                    @if ($errors->has('currentPassword'))
                                    <span class="text-danger">{{ $errors->first('currentPassword')
                                        }}</span>
                                    @endif
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger">{{ $errors->first('rePassword')
                                        }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="col-12 d-flex justify-content-end">
                                ...
                                <button type="button" id="cancel" class="btn btn-primary me-1 mb-1 hide">
                                    Cancel
                                </button>
                                <button type="submit" id="submit" onClick="return validate()"
                                    class="btn btn-primary me-1 mb-1 submit hide">
                                    Submit
                                </button>
                                <button type="reset" class="btn btn-light-secondary me-1 mb-1 submit hide">
                                    Reset
                                </button>
                            </div>
                        </div>
