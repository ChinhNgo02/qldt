            ...
            <div class="card-body">
                <div class="col-12 d-flex justify-content-start mb-3">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#import-user"
                        class="btn btn-primary me-1"><i class="fas
                            fa-file-upload"> </i> Tải lên sinh viên</button>
                    <button type="button" data-bs-toggle="modal" data-bs-target="#add-user-modal"
                        class="btn btn-success me-1"><i class="fas fa-plus">
                        </i> Thêm người dùng</button>
                </div>
            ...
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <center>
                            <a href="{{
                                asset('files/excel/user-import-example.xlsx')
                                }}" class="btn btn-primary mb-5"><i class="fas
                                    fa-file-upload"> </i>Tải file mẫu</a>
                                ...
                                <div class="input-group">
                                    <form action="{{ route('user.import') }}" method="POST"
                                        ...
                                        <button type="submit" class="btn
                                            btn-info" OnClick="return confirm('Are you
                                            sure ?')">Import</button>
                                    </form>
